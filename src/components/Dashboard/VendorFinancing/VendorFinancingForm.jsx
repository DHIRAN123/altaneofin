...
const VendorFinancingForm = (props) => {
  ...
  const onSubmitThirdForm = async (e) => {
    ...
    const uuid = 'abc123'; 
    const url = `http://ec2-35-154-147-165.ap-south-1.compute.amazonaws.com:8080/createBusinessVerification?uuid=${uuid}`;
  ...
  const onClickSubmit = async (e) => {
    ...
    const uuid = 'abc123'; 
    const uploadUrl = `http://ec2-35-154-147-165.ap-south-1.compute.amazonaws.com:8080/documents/upload?uuid=${uuid}`;
        ...
        <>
          <div className="max-w-4xl lg:max-w-full mx-auto bg-gray-100 p-8 rounded-md">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
              <div>
                <h1 className="text-3xl font-bold text-gray-800">Please Complete KYC</h1>
